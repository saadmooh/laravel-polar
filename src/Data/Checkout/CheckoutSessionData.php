...
class ProductPriceCast implements Cast
{
    public function cast(DataProperty $property, mixed $value, array $properties, CreationContext $context): mixed
    {
        ...
        // Determine the price type based on the discriminator field
        $priceType = $value['amount_type'] ?? null;
        // dd($priceType);
        // Determine if this is a legacy recurring product price
        $isLegacyRecurring = $value['type']==="recurring" ? true : false;
       // dd($isLegacyRecurring);
        // Use the discriminator to determine which class to instantiate
        return match (true) {
            // Legacy recurring product prices
