...
namespace Saadmooh\LaravelPolar;

use Saadmooh\LaravelPolar\Commands\ListProductsCommand;
use Saadmooh\LaravelPolar\View\Components\Button;
        ...
        $package
            ...
            ->hasInstallCommand(function (InstallCommand $command) {
                $command
                    ...
                    ->askToStarRepoOnGitHub('saadmooh/laravel-polar');
            });
    }
